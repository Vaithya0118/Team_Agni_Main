...
function initializeView() {
  ...
  //const prevButon = createButton();
  const prevButton = document.getElementById("prev")
  initializeButton(prevButton, "Previous", "block");

  //const nextButon = createButton();
  const nextButton = document.getElementById("next")
  initializeButton(nextButton, "Next", "block");

  addInteractivity(playButon, pauseButon);
  addInteractivity(pauseButon, playButon);
  addInteractivity(prevButton,nextButton);
  addInteractivity(nextButton,prevButton);
